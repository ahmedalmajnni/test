...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Invoices</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ Partially Paid Invoices</span>
            </div>
        </div>
            ...
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <a href="invoice/create" class="modal-effect btn btn-sm btn-primary" style="color:white"><i
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu tx-13">
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="Status_show/{{ $invoice->id }}"><i
                                                            class=" text-success fas
                                                                                                                                                        fa-money-bill"></i>&nbsp;&nbsp;Change
                                                        Payment
                                                        Status</a>
