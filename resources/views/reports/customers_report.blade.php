...
@section('title')
    Customer Report - Mora Soft for Invoice Management
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <form action="/customer_search" method="POST" role="search" autocomplete="off">
                    {{ csrf_field() }}
                    ...
                    <div class="row">
                        <div class="col-sm-1 col-md-1">
                            <button class="btn btn-primary btn-block" style="padding: 10px 20px; font-size: 14px;">Search</button>
                        </div>
                    </div>
