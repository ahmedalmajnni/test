...
<div class="breadcrumb-header justify-content-between">
    <div class="left-content">
        <div>
            <h3 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">Hi, welcome to our website</h3>
        </div>
    </div>
...
<div class="row row-sm">
                    ...
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{ $total = \App\Models\Invoice::count() }} num is
                            </p>
                        </div>
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{ $num1 = \App\Models\Invoice::where('Value_Status', 1)->count() }} num is
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white op-7">
                                {{ number_format(($num1 / $total) * 100, 0) }}%
            ...
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                ...
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                {{ \App\Models\Invoice::where('Value_Status', 0)->sum('Total') }}
                            </h4>
                            <p class="mb-0 tx-12 text-white op-7">
                                {{ $num2 = \App\Models\Invoice::where('Value_Status', 0)->count() }} num is
                            </p>
                        </div>
                        <span class="float-right my-auto mr-auto">
                            <i class=""></i>
                            <span class="text-white op-7">
                                {{ number_format(($num2 / $total) * 100, 0) }}%
    ...
    <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
        <div class="card overflow-hidden sales-card bg-success-gradient">
            <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                <div class="">
                    <h6 class="mb-3 tx-12 text-white">partlly paid invoices</h6>
                </div>
                <div class="pb-0 mt-0">
                    <div class="d-flex">
                        <div class="">
                            ...
                            <p class="mb-0 tx-12 text-white op-7">
                                {{ $num3 = \App\Models\Invoice::where('Value_Status', 2)->count() }} num is
                        ...
                        <span class="float-right my-auto mr-auto">
                            ...
                            <span class="text-white op-7">
                                ...
                                {{ number_format(($num3 / $total) * 100, 0) }}%
                            </span>
                        </span>
                    </div>
                </div>
